...
class MylomRepository {
  ...
  async populate(record) {
    ...
    /* if (record.user.id !== FirebaseRepository.getCurrentUser.id) {
      return record;
    } */

    /* if (FirebaseRepository.getCurrentUser() === FirebaseRepository.getCurrentUser()) {
...
module.exports = MylomRepository;
