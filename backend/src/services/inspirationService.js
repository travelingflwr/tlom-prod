...
/**
 * Handles Inspiration operations
 */
module.exports = class InspirationService {
  constructor({ currentUser, language }) {
    this.repository = new InspirationRepository();
    this.currentUser = currentUser;
    this.language = language;
  }

  /**
   * Creates a Inspiration.
   *
   * @param {*} data
   */
  async create(data) {
  ...
  /**
   * Destroy all Inspirations with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds Inspirations for Autocomplete.
   *
   * @param {*} search
   * @param {*} limit
   */
  ...
  /**
   * Finds Inspirations based on the query.
   *
   * @param {*} args
   */
  ...
  /**
   * Imports a list of Inspirations.
   *
   * @param {*} data
   * @param {*} importHash
   */
