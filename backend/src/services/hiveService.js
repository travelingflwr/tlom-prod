 ...
 */
module.exports = class HiveService {
  ...
  /**
   * Destroy all Hives with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds Hives based on the query.
   *
   * @param {*} args
   */
