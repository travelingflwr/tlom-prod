...
/**
 * Handles myList operations
 */
module.exports = class myListService {
  constructor({ currentUser, language }) {
    this.repository = new myListRepository();
  ...
  /**
   * Destroy all myLists with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds myListss for Autocomplete.
   *
   * @param {*} search
   * @param {*} limit
   */
  ...
  /**
   * Finds myLists based on the query.
   *
   * @param {*} args
   */
