...
import InspirationFormModal from 'view/inspiration/form/InspirationFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/inspiration/inspirationSelectors';

class InspirationAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return InspirationService.listAutocomplete(value, limit);
  };
...
export default connect(select)(
  InspirationAutocompleteFormItem,
);
