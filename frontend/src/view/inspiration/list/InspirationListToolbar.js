...
class InspirationToolbar extends Component {
  state = {
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="inspiration-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="inspiration-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="inspiration-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="inspiration-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=inspiration">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: inspirationSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: inspirationSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(InspirationToolbar);
