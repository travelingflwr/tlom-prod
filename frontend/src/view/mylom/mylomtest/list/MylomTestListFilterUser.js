...
class MylomTestListFilterUser extends Component {
  componentDidMount() {
  ...
  render() {
    const { loading, currentUser, isMylomOwner } = this.props;
...
function select(state) {
  return {
    ...
    isMylomOwner: authSelectors.selectCurrentUserIsMylomOwner(
      state,
    ),
  };
}
...
export default withRouter(connect(select)(MylomTestListFilterUser));
