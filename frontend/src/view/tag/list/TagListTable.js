...
import InspirationListItem from 'view/inspiration/list/InspirationListItem';
                  ...
                  <tr key={row.id}>
                    <th className="th-checkbox" scope="row">
                      <div className="custom-control custom-checkbox">
                        ...
                        <td>
                          <InspirationListItem value={row[fields.inspiration.name]} />
                        </td>
                        <td>
...
export default connect(select)(TagListTable);
