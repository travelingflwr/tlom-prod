...
import actions from 'modules/list/list/listListActions';
import selectors from 'modules/list/list/listListSelectors';
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="list-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="list-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="list-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="list-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=list">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: listSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: listSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(ListToolbar);
