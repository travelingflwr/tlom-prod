...
import actions from 'modules/subscription/list/subscriptionListActions';
import selectors from 'modules/subscription/list/subscriptionListSelectors';
...
class SubscriptionToolbar extends Component {
  state = {
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="subscription-list-toolbar-export-tooltip"
        >
          {button}
          <ReactTooltip id="subscription-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="subscription-list-toolbar-destroy-tooltip"
        >
          {button}
          <ReactTooltip id="subscription-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=subscription">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: subscriptionSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: subscriptionSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(SubscriptionToolbar);
