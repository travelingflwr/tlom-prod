...
class SubscriptionListFilter extends Component {
  componentDidMount() {
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-6 col-12">
                      <InputNumberRangeFormItem
                        name={
                          fields.durationRange.name
                        }
                        label={
                          fields.durationRange.label
                        }
                      />
                    </div>
                  </div>
...
export default withRouter(connect(select)(SubscriptionListFilter));
