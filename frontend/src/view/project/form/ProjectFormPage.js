...
import actions from 'modules/project/form/projectFormActions';
import selectors from 'modules/project/form/projectFormSelectors';
...
export default connect(select)(ProjectFormPage);
