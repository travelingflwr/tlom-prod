...
function select(state) {
  return {
    ...
    hasPermissionToCreate: projectSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: projectSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(ProjectToolbar);
