...
import exporterFields from 'modules/inspiration/list/inspirationListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'INSPIRATION_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await InspirationService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.inspiration.exporterFileName'),
