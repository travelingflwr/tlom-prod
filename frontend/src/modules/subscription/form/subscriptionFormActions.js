...
const prefix = 'SUBSCRIPTION_FORM';
...
const actions = {
  ...
  doCreate: (values) => async (dispatch) => {
    try {
      ...
      Message.success(i18n('entities.subscription.create.success'));
  ...
  doUpdate: (id, values) => async (
    ...
    try {
      ...
      await SubscriptionService.update(id, values);

      dispatch({
        type: actions.UPDATE_SUCCESS,
      });

      Message.success(i18n('entities.subscription.update.success'));
