import listActions from 'modules/subscription/list/subscriptionListActions';
...
const actions = {
  ...
  doDestroy: (id) => async (dispatch) => {
    try {
      ...
      await SubscriptionService.destroyAll([id]);

      dispatch({
        type: actions.DESTROY_SUCCESS,
      });

      Message.success(i18n('entities.subscription.destroy.success'));
  ...
  doDestroyAll: (ids) => async (dispatch) => {
    try {
      ...
      await SubscriptionService.destroyAll(ids);
      ...
      Message.success(
        i18n('entities.subscription.destroyAll.success'),
      );
