...
import exporterFields from 'modules/mylist/list/myListListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'MYLIST_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await myListService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.mylist.exporterFileName'),
