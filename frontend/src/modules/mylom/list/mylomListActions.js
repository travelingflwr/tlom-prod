...
import exporterFields from 'modules/mylom/list/mylomListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'MYLOM_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await MylomService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.mylom.exporterFileName'),
