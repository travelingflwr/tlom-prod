...
import exporterFields from 'modules/hive/list/hiveListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'HIVE_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await HiveService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.hive.exporterFileName'),
